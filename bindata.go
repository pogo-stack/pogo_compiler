...
// templates/template_psp_function_end_raw_routed.sql
// templates/template_psp_function_end_routed.sql
// templates/template_psp_function_end_view.sql
// templates/template_psp_function_end_view_routed.sql
// DO NOT EDIT!
...
var _templatesTemplate_psp_function_end_raw_routedSql = []byte("")

func templatesTemplate_psp_function_end_raw_routedSqlBytes() ([]byte, error) {
	return bindataRead(
		_templatesTemplate_psp_function_end_raw_routedSql,
		"templates/template_psp_function_end_raw_routed.sql",
	)
}

func templatesTemplate_psp_function_end_raw_routedSql() (*asset, error) {
	bytes, err := templatesTemplate_psp_function_end_raw_routedSqlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "templates/template_psp_function_end_raw_routed.sql", size: 76, mode: os.FileMode(438), modTime: time.Unix(1583153605, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _templatesTemplate_psp_function_end_view_routedSql = []byte("\x1f\x8b\x08\x00\x00\x00\x00\x00\x00\xff\xe2\xe2\x02\x04\x00\x00\xff\xff\x6b\x13\xe3\x5b\x02\x00\x00\x00")

func templatesTemplate_psp_function_end_view_routedSqlBytes() ([]byte, error) {
	return bindataRead(
		_templatesTemplate_psp_function_end_view_routedSql,
		"templates/template_psp_function_end_view_routed.sql",
	)
}

func templatesTemplate_psp_function_end_view_routedSql() (*asset, error) {
	bytes, err := templatesTemplate_psp_function_end_view_routedSqlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "templates/template_psp_function_end_view_routed.sql", size: 2, mode: os.FileMode(438), modTime: time.Unix(1559982035, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _bindata = map[string]func() (*asset, error){
	...
	"templates/template_psp_function_end_raw_routed.sql": templatesTemplate_psp_function_end_raw_routedSql,
	...
	"templates/template_psp_function_end_view_routed.sql": templatesTemplate_psp_function_end_view_routedSql,
}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"templates": &bintree{nil, map[string]*bintree{
		...
		"template_psp_function_end_raw_routed.sql": &bintree{templatesTemplate_psp_function_end_raw_routedSql, map[string]*bintree{}},
		...
		"template_psp_function_end_view_routed.sql": &bintree{templatesTemplate_psp_function_end_view_routedSql, map[string]*bintree{}},
	}},
}}
