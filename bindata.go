...
func templatesTemplate_psp_function_endSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/template_psp_function_end.sql", size: 2634, mode: os.FileMode(438), modTime: time.Unix(1560865703, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
